<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Sucursal.aspx.cs" Inherits="HappyPet4._0.Ventas.Sucursal" %>
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <asp:GridView runat="server" Style="align-content: center" CssClass="box" Width="100%" ID="gvSucursales" OnRowCommand="gvSucursales_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None" AllowSorting="True">
    ...
    <div class="modal fade" id="ModalSucursal" role="dialog" aria-labelledby="ModalSucursalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                               <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txtIdSucursal" runat="server" CssClass="form-control" MaxLength="50" ReadOnly="True"></asp:TextBox>
                                ...
                                <div class="col-lg-6">
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-10">
                                             <asp:DropDownList ID="ddlIdEmpresa" runat="server" CssClass="form-control" ></asp:DropDownList>
                                             <!-- <input type="text" maxlength="50" class="form-control"/> -->
                                         </div>
                                     </div>
                                 </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nombre Sucursal: </label>
                                            <div class="col-sm-10">
