<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Raza.aspx.cs" Inherits="HappyPet4._0.Ventas.Raza" %>
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">

    <div class="row">
        <div class="container well">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-file-text-o">&nbsp</i>Raza</h3>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-3">
                                    <asp:Button runat="server" ID="btnAgregar" Text="Agregar Raza " CssClass="btn btn-success" OnClick="btnAgregar_Click" />
                                </div>
                                <div class="col-sm-3">
                                    <asp:Button runat="server" ID="btnEditar" Text="Editar Raza " CssClass="btn btn-warning" OnClick="btnEditar_Click" />
                                </div>
                                <div class="col-sm-3">
                                    <asp:Button runat="server" ID="btnEliminar" Text="Eliminar Raza" CssClass="btn btn-danger" OnClick="btnEliminar_Click" />
                                </div>
                        ...
                        <div class="col-sm-12">
                            <asp:GridView runat="server" Style="align-content: center" CssClass="box" Width="100%" ID="gvRazas" OnRowCommand="gvRazas_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None" AllowSorting="True">
     ...
     <div class="modal fade" id="ModalRaza" role="dialog" aria-labelledby="ModalRazaLabel" aria-hidden="true">
                            ...
                            <div class="row">
                               <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txtIdRaza" runat="server" CssClass="form-control" MaxLength="50" ReadOnly="True"></asp:TextBox>
                                ...
                                <div class="col-lg-6">
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-10">
                                             <asp:DropDownList ID="ddlIdEspecie" runat="server" CssClass="form-control" ></asp:DropDownList>
                                             <!-- <input type="text" maxlength="50" class="form-control"/> -->
                                         </div>
                                     </div>
                                 </div>
