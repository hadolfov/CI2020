<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Empresa.aspx.cs" Inherits="HappyPet4._0.Ventas.Empresa" %>
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">

    <div class="row">
        <div class="container well">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-file-text-o">&nbsp</i>Empresa</h3>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <asp:GridView runat="server" Style="align-content: center" CssClass="box" Width="100%" ID="gvEmpresas" OnRowCommand="gvEmpresas_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None" AllowSorting="True">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <label class="col-sm-2 control-label">Id Empresa: </label>
                                     <div class="col-sm-10">
                                     <asp:TextBox ID="txtIdEmpresa" runat="server" CssClass="form-control" MaxLength="50" ReadOnly="True"></asp:TextBox>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <hr />
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-10">
                                             <asp:TextBox ID="txtCedula" placeholder="Cedula Juridica" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>
                                         </div>
                                     </div>
                                 </div>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-10">
                                             <asp:TextBox ID="txtNombre" placeholder="Nombre de la Empresa" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">ID TIPO IDENTIFICACION: </label>
